...
import com.sakinr.airportreservationsystem.handler.GenericExceptionHandler;
import com.sakinr.airportreservationsystem.service.impl.AirportCompanyServiceImpl;
...
class AirportCompanyControllerTest {
    ...
    void getAllAirportCompanies() throws Exception {
        ...
        // stub - given
        Mockito.when(airportCompanyService.getAllAirportCompanies()).thenReturn(airportCompanies);
        ...
        Assert.assertEquals(airportCompanies.size(), actualAirportCompanies.size());
